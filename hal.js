...
function mapConcertListToRessourceObject(concertData) {

    //préparation des concerts "embarqués" comme ressource
    //par la ressource "la liste des concerts"

    const embedded = concertData.map( concertData => mapConcertoResourceObject(concertData))
...
module.exports = { halLinkObject, mapConcertoResourceObject, mapConcertListToRessourceObject };
